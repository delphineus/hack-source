...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return queryInterface.bulkInsert('ResourceTags', [
      ...
      { ResourceId: 2, TagId: 1, createdAt: new Date(), updatedAt: new Date() },
      ...
      { ResourceId: 3, TagId: 2, createdAt: new Date(), updatedAt: new Date() },
      { ResourceId: 1, TagId: 3, createdAt: new Date(), updatedAt: new Date() },
