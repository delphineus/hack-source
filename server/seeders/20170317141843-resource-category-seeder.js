...
module.exports = {
  up: function (queryInterface, Sequelize) {
    return queryInterface.bulkInsert('ResourceCategories', [
      ...
      { ResourceId: 2, CategoryId: 1, createdAt: new Date(), updatedAt: new Date() },
      ...
      { ResourceId: 3, CategoryId: 2, createdAt: new Date(), updatedAt: new Date() },
      { ResourceId: 1, CategoryId: 3, createdAt: new Date(), updatedAt: new Date() },
